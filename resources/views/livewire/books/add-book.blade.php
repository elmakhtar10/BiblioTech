<div>
    ...
    <button class="btn btn-primary mb-3" wire:click="openBookForm">
    ...
    @if($showForm)
        ...
        <div class="modal-content" style="position: fixed; top: 10%; left: 50%; transform: translateX(-50%); width: 50%; background: #fff; padding: 20px; border-radius: 8px; z-index: 100;">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <button wire:click="closeBookForm" style="background:none; border:none; font-size:1.5rem;">&times;</button>
            </div>
            ...
            <form wire:submit.prevent="save" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-end gap-2 mt-3">
                    <button type="button" class="btn btn-secondary" wire:click="closeBookForm">Annuler</button>
