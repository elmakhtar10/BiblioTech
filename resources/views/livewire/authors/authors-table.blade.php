                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        ...
                        <tr wire:key="{{$author->id}}">
                            ...
                            <td class="text-end">
                                {{-- Bouton EDIT --}}
                                <button class="btn btn-primary btn-sm" wire:click="$dispatch('openForm', [{{ $author->id }}])">
                                ...
                                {{-- Bouton Supprimer --}}
                                <button class="btn btn-danger btn-sm" onclick="confirm('Voulez-vous vraiment supprimer l\'auteur {{$author->nom}} ?') || event.stopImmediatePropagation()" wire:click="delete({{$author->id}})">
